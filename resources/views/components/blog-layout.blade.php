...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" 
      class="h-full scroll-smooth bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased">
<head>
    <meta charset="utf-8">
    ...
    {{-- Script: Runs immediately to prevent FOUC by setting the class before render --}}
    <script>
    ...
    {{-- Just x-cloak here. We removed the hardcoded background colors. --}}
    <style>[x-cloak] { display: none !important; }</style>

    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

{{-- Colors added to Body as well to ensure content backgrounds layer correctly --}}
<body class="flex flex-col min-h-screen font-sans selection:bg-blue-600 selection:text-white bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100"
      x-data="{ 
          searchOpen: false, 
          menuOpen: false,
...
>
    ...
    {{-- Navigation --}}
    <nav class="sticky top-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button @click="theme === 'system' ? updateTheme('light') : (theme === 'light' ? updateTheme('dark') : updateTheme('system'))" 
                            :title="theme === 'system' ? 'Switch to Light' : (theme === 'light' ? 'Switch to Dark' : 'Switch to System')"
